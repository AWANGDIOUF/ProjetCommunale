...
export class QuartierComponent implements OnInit {
  ...
  trackId(index: number, item: IQuartier): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IQuartier[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
