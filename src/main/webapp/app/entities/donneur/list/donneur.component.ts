...
export class DonneurComponent implements OnInit {
  ...
  trackId(index: number, item: IDonneur): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IDonneur[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
