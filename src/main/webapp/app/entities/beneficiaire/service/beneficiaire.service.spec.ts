...
describe('Beneficiaire Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      typeBeneficiaire: TypeBeneficiaire.Groupement,
      autreBeneficiaire: 'AAAAAAA',
      description: 'AAAAAAA',
  ...
  describe('Service methods', () => {
    ...
    it('should update a Beneficiaire', () => {
      const returnedFromService = Object.assign(
        {
          id: 1,
          typeBeneficiaire: 'BBBBBB',
          autreBeneficiaire: 'BBBBBB',
          description: 'BBBBBB',
    ...
    describe('addBeneficiaireToCollectionIfMissing', () => {
      ...
      it('should add only unique Beneficiaire to an array', () => {
        const beneficiaireArray: IBeneficiaire[] = [{ id: 123 }, { id: 456 }, { id: 84996 }];
