...
describe('Logiciel Management Component', () => {
  let comp: LogicielComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(LogicielComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.logiciels?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
});
