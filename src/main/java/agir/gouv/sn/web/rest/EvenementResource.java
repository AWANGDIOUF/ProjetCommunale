...
/**
 * REST controller for managing {@link agir.gouv.sn.domain.Evenement}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Evenement> partialUpdateEvenement(
        ...
        Optional<Evenement> result = evenementRepository
            ...
            .map(existingEvenement -> {
                if (evenement.getNomEvenement() != null) {
                    existingEvenement.setNomEvenement(evenement.getNomEvenement());
                }
                if (evenement.getLibelle() != null) {
                    existingEvenement.setLibelle(evenement.getLibelle());
                }
                if (evenement.getAction() != null) {
                    existingEvenement.setAction(evenement.getAction());
                }
                if (evenement.getDecision() != null) {
                    existingEvenement.setDecision(evenement.getDecision());
                }
                if (evenement.getDelaiInstruction() != null) {
                    existingEvenement.setDelaiInstruction(evenement.getDelaiInstruction());
                }
                if (evenement.getDelaiInscription() != null) {
                    existingEvenement.setDelaiInscription(evenement.getDelaiInscription());
                }
                if (evenement.getDelaiValidation() != null) {
                    existingEvenement.setDelaiValidation(evenement.getDelaiValidation());
                }
