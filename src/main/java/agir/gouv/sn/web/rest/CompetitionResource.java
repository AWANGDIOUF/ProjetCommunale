...
/**
 * REST controller for managing {@link agir.gouv.sn.domain.Competition}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Competition> result = competitionRepository
            ...
            .map(existingCompetition -> {
                if (competition.getDateCompetition() != null) {
                    existingCompetition.setDateCompetition(competition.getDateCompetition());
                }
                if (competition.getLieuCompetition() != null) {
                    existingCompetition.setLieuCompetition(competition.getLieuCompetition());
                }
                if (competition.getDiscipline() != null) {
                    existingCompetition.setDiscipline(competition.getDiscipline());
                }
