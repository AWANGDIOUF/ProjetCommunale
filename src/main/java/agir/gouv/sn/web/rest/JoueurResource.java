...
/**
 * REST controller for managing {@link agir.gouv.sn.domain.Joueur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Joueur> partialUpdateJoueur(
        ...
        Optional<Joueur> result = joueurRepository
            ...
            .map(existingJoueur -> {
                ...
                if (joueur.getPrenomJoueur() != null) {
                    existingJoueur.setPrenomJoueur(joueur.getPrenomJoueur());
                }
                if (joueur.getDateNaisJoueur() != null) {
                    existingJoueur.setDateNaisJoueur(joueur.getDateNaisJoueur());
                }
                if (joueur.getLieuNaisJoueur() != null) {
                    existingJoueur.setLieuNaisJoueur(joueur.getLieuNaisJoueur());
                }
                if (joueur.getPosteJoueur() != null) {
                    existingJoueur.setPosteJoueur(joueur.getPosteJoueur());
                }
                if (joueur.getPhotoJoueur() != null) {
                    existingJoueur.setPhotoJoueur(joueur.getPhotoJoueur());
                }
                if (joueur.getPhotoJoueurContentType() != null) {
                    existingJoueur.setPhotoJoueurContentType(joueur.getPhotoJoueurContentType());
                }
