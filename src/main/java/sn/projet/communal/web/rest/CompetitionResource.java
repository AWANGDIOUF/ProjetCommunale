...
/**
 * REST controller for managing {@link sn.projet.communal.domain.Competition}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CompetitionResource {
            ...
            .map(
                existingCompetition -> {
                    ...
                    if (competition.getLieu() != null) {
                        existingCompetition.setLieu(competition.getLieu());
                    }
    ...
    public ResponseEntity<List<Competition>> getAllCompetitions(
        ...
        if (eagerload) {
            page = competitionRepository.findAllWithEagerRelationships(pageable);
        } else {
