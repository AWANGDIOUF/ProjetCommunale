...
/**
 * REST controller for managing {@link sn.projet.communal.domain.Donneur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class DonneurResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/donneurs/{id}", consumes = "application/merge-patch+json")
     ...
     */
    @GetMapping("/donneurs")
    public ResponseEntity<List<Donneur>> getAllDonneurs(Pageable pageable) {
        log.debug("REST request to get a page of Donneurs");
        Page<Donneur> page = donneurRepository.findAll(pageable);
