...
import sn.projet.communal.repository.CibleRepository;
...
/**
 * REST controller for managing {@link sn.projet.communal.domain.Cible}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class CibleResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/cibles/{id}", consumes = "application/merge-patch+json")
    ...
    public ResponseEntity<List<Cible>> getAllCibles(Pageable pageable) {
        ...
        Page<Cible> page = cibleRepository.findAll(pageable);
