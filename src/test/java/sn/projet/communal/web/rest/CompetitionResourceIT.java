...
import sn.projet.communal.repository.CompetitionRepository;
...
class CompetitionResourceIT {
    ...
    public static Competition createEntity(EntityManager em) {
        Competition competition = new Competition().date(DEFAULT_DATE).lieu(DEFAULT_LIEU).discipline(DEFAULT_DISCIPLINE);
        return competition;
    }
    ...
    public static Competition createUpdatedEntity(EntityManager em) {
        Competition competition = new Competition().date(UPDATED_DATE).lieu(UPDATED_LIEU).discipline(UPDATED_DISCIPLINE);
        return competition;
    }
    ...
    void createCompetition() throws Exception {
        ...
        assertThat(testCompetition.getLieu()).isEqualTo(DEFAULT_LIEU);
    ...
    void putNewCompetition() throws Exception {
        ...
        updatedCompetition.date(UPDATED_DATE).lieu(UPDATED_LIEU).discipline(UPDATED_DISCIPLINE);
        ...
        assertThat(testCompetition.getLieu()).isEqualTo(UPDATED_LIEU);
    ...
    void partialUpdateCompetitionWithPatch() throws Exception {
        ...
        partialUpdatedCompetition.date(UPDATED_DATE).lieu(UPDATED_LIEU).discipline(UPDATED_DISCIPLINE);
