...
class TypeVaccinResourceIT {
    ...
    public static TypeVaccin createEntity(EntityManager em) {
        TypeVaccin typeVaccin = new TypeVaccin().libelle(DEFAULT_LIBELLE);
        return typeVaccin;
    }
    ...
    public static TypeVaccin createUpdatedEntity(EntityManager em) {
        TypeVaccin typeVaccin = new TypeVaccin().libelle(UPDATED_LIBELLE);
        return typeVaccin;
    }
    ...
    void putNewTypeVaccin() throws Exception {
        ...
        updatedTypeVaccin.libelle(UPDATED_LIBELLE);
    ...
    void fullUpdateTypeVaccinWithPatch() throws Exception {
        ...
        partialUpdatedTypeVaccin.libelle(UPDATED_LIBELLE);
