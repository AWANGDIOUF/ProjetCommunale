...
import agir.gouv.sn.domain.Inscription;
import agir.gouv.sn.repository.InscriptionRepository;
...
class InscriptionResourceIT {
    ...
    private static final String DEFAULT_TEL_1_PERS = "AAAAAAAAAA";
    private static final String UPDATED_TEL_1_PERS = "BBBBBBBBBB";

    private static final Boolean DEFAULT_ETAT_INSCRIPTION = false;
    private static final Boolean UPDATED_ETAT_INSCRIPTION = true;
    ...
    public static Inscription createEntity(EntityManager em) {
        Inscription inscription = new Inscription()
            ...
            .tel1Pers(DEFAULT_TEL_1_PERS)
            .etatInscription(DEFAULT_ETAT_INSCRIPTION);
        return inscription;
    }
    ...
    public static Inscription createUpdatedEntity(EntityManager em) {
        Inscription inscription = new Inscription()
            ...
            .tel1Pers(UPDATED_TEL_1_PERS)
            .etatInscription(UPDATED_ETAT_INSCRIPTION);
        return inscription;
    }
    ...
    void createInscription() throws Exception {
        ...
        assertThat(testInscription.getNomPers()).isEqualTo(DEFAULT_NOM_PERS);
        assertThat(testInscription.getPrenomPers()).isEqualTo(DEFAULT_PRENOM_PERS);
        assertThat(testInscription.getEmailPers()).isEqualTo(DEFAULT_EMAIL_PERS);
        assertThat(testInscription.getTelPers()).isEqualTo(DEFAULT_TEL_PERS);
        assertThat(testInscription.getTel1Pers()).isEqualTo(DEFAULT_TEL_1_PERS);
        assertThat(testInscription.getEtatInscription()).isEqualTo(DEFAULT_ETAT_INSCRIPTION);
    }
    ...
    @Test
    @Transactional
    void checkTelPersIsRequired() throws Exception {
        int databaseSizeBeforeTest = inscriptionRepository.findAll().size();
        // set the field null
        inscription.setTelPers(null);
    ...
    void getAllInscriptions() throws Exception {
        ...
        restInscriptionMockMvc
            ...
            .andExpect(jsonPath("$.[*].tel1Pers").value(hasItem(DEFAULT_TEL_1_PERS)))
            .andExpect(jsonPath("$.[*].etatInscription").value(hasItem(DEFAULT_ETAT_INSCRIPTION.booleanValue())));
    }
    ...
    void getInscription() throws Exception {
        ...
        restInscriptionMockMvc
            ...
            .andExpect(jsonPath("$.tel1Pers").value(DEFAULT_TEL_1_PERS))
            .andExpect(jsonPath("$.etatInscription").value(DEFAULT_ETAT_INSCRIPTION.booleanValue()));
    }
    ...
    void putNewInscription() throws Exception {
        ...
        Inscription testInscription = inscriptionList.get(inscriptionList.size() - 1);
        assertThat(testInscription.getNomPers()).isEqualTo(UPDATED_NOM_PERS);
        assertThat(testInscription.getPrenomPers()).isEqualTo(UPDATED_PRENOM_PERS);
        assertThat(testInscription.getEmailPers()).isEqualTo(UPDATED_EMAIL_PERS);
        assertThat(testInscription.getTelPers()).isEqualTo(UPDATED_TEL_PERS);
        assertThat(testInscription.getTel1Pers()).isEqualTo(UPDATED_TEL_1_PERS);
        assertThat(testInscription.getEtatInscription()).isEqualTo(UPDATED_ETAT_INSCRIPTION);
    }
